		...
		var BudgetDataDS;
		var DataTotalsDS;
		var Budget_Data="https://dashboard.udot.utah.gov/resource/c9s4-gvqp.json?$query=SELECT%20group_id,groups,sum(current_budget)%20AS%20budget,sum(amount)%20AS%20expenditure,sum(revenue)%20AS%20revenue,sum(expense_budget_difference)%20AS%20difference%20WHERE%20fiscal_year=2017%20AND%20group_id%20in%20(%278204%27,%20%278205%27,%20%278206%27,%20%278211%27,%20%278212%27,%20%278217%27,%20%278219%27,%20%278220%27,%20%278240%27,%20%278245%27,%20%278260%27,%20%278270%27,%20%278280%27,%20%278295%27,%20%278259%27)%20AND%20starts_with(appropriation,%27X%27)%20AND%20(fund_id=%272800%27%20OR%20fund_id=%272820%27)%20AND%20account_type%20in%20(%2722%27,%20%2731%27,%20%2742%27) AND "+ date +" = "+ date + "%20GROUP%20BY%20group_id,groups%20ORDER%20BY%20group_id"
		
var Data_Totals = "https://dashboard.udot.utah.gov/resource/c9s4-gvqp.json?$query=SELECT%20sum(current_budget)%20AS%20budget,sum(amount)%20AS%20expenditure,sum(revenue)%20AS%20revenue,sum(expense_budget_difference)%20AS%20difference%20WHERE%20fiscal_year=2017%20AND%20group_id%20in%20(%278204%27,%20%278205%27,%20%278206%27,%20%278211%27,%20%278212%27,%20%278217%27,%20%278219%27,%20%278220%27,%20%278240%27,%20%278245%27,%20%278260%27,%20%278270%27,%20%278280%27,%20%278295%27,%20%278259%27)%20AND%20starts_with(appropriation,%27X%27)%20AND%20(fund_id=%272800%27%20OR%20fund_id=%272820%27)%20AND%20account_type%20in%20(%2722%27,%20%2731%27,%20%2742%27) AND "+ date +" = "+ date + ""
		...
		function setBudgetData(){
			...
			document.getElementById("Group13").innerHTML = BudgetDataDS[12].groups;
			document.getElementById("GroupID13").innerHTML = BudgetDataDS[12].group_id;
			document.getElementById("Budget13").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[12].budget));
			document.getElementById("Revenue13").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[12].revenue));
			document.getElementById("Spent13").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[12].expenditure));
			document.getElementById("Difference13").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[12].difference));
			document.getElementById("Group14").innerHTML = BudgetDataDS[13].groups;
			document.getElementById("GroupID14").innerHTML = BudgetDataDS[13].group_id;
			document.getElementById("Budget14").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[13].budget));
			document.getElementById("Revenue14").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[13].revenue));
			document.getElementById("Spent14").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[13].expenditure));
			document.getElementById("Difference14").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[13].difference));
			document.getElementById("Group15").innerHTML = BudgetDataDS[14].groups;
			document.getElementById("GroupID15").innerHTML = BudgetDataDS[14].group_id;
			document.getElementById("Budget15").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[14].budget));
			document.getElementById("Revenue15").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[14].revenue));
			document.getElementById("Spent15").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[14].expenditure));
			document.getElementById("Difference15").innerHTML = numberWithCommas(CurrencyFormatted(BudgetDataDS[14].difference));
		}
		
		function setDataTotals(){
			//Data Totals
			document.getElementById("Budget16").innerHTML = numberWithCommas(CurrencyFormatted(DataTotalsDS[0].budget));
			document.getElementById("Revenue16").innerHTML = numberWithCommas(CurrencyFormatted(DataTotalsDS[0].revenue));
			document.getElementById("Spent16").innerHTML = numberWithCommas(CurrencyFormatted(DataTotalsDS[0].expenditure));
			document.getElementById("Difference16").innerHTML = numberWithCommas(CurrencyFormatted(DataTotalsDS[0].difference));
		}
